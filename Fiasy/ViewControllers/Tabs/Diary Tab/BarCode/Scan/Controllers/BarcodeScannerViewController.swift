...
open class BarcodeScannerViewController: UIViewController {
  ...
  public var isOneTimeSearch = false
...
//    add(childViewController: messageViewController, container: view)
//    messageView.translatesAutoresizingMaskIntoConstraints = false
//    collapsedConstraints.activate()

    cameraViewController.metadata = metadata
    cameraViewController.delegate = self
    add(childViewController: cameraViewController, container: containerView)
