...
class TutorialViewController: UIViewController, UIScrollViewDelegate {
    ...
    func createSlides() -> [Slide] {
        ...
        slide1.imageView.image = UIImage(named: "pict1_onboard_1x")
       
        
        let slide2:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
        slide2.imageView.image = UIImage(named: "pict2_onboard_1x")
        
        
        let slide3:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
        slide3.imageView.image = UIImage(named: "pict3_onboard_1x")
        
        
        let slide4:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
        slide4.imageView.image = UIImage(named: "pict4_onboard_1x")
        
        
        
        let slide5:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
        slide5.imageView.image = UIImage(named: "pict5_onboard_1x")
