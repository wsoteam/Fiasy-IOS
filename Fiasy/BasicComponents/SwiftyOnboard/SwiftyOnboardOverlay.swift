...
open class SwiftyOnboardOverlay: UIView {
    ...
    open var pageControl: UIPageControl = {
        ...
        pageControl.currentPageIndicatorTintColor = #colorLiteral(red: 0.2587913275, green: 0.2588421106, blue: 0.2587881684, alpha: 1)
        pageControl.tintColor = #colorLiteral(red: 0.8155969381, green: 0.8157377839, blue: 0.815588057, alpha: 1)
        return pageControl
    }()
//
